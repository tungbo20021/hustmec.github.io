	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				<h1 class="mt-4" style="color: #007BFF; text-align: center;">Danh sách file thiết bị</h1>
<!--				<hr>
...
-->	
				...
				<table class="table table-bordered" border="1" cellpadding="4"
					...
					<tr class="tr2">
						...
						<th align="left" width="25%">Tên File</th>
						<th align="left" width="25%">User tải lên</th>

					</tr>
					<c:forEach items="${listFiles}" var="file">
						<tr>
							<td align="left"><c:out value="${file.fileID}" /></td>
							<td><a href="ViewDetailFile.do?fileID=${file.fileID}"><c:out value="${file.fileName}" /></a></td>
